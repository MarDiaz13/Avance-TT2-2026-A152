                ...
                <div className="dev-team-grid">
                    <div className="about-card card-body">
                        ...
                        <div className="dev-info-list">
                            <div className="dev-info-item"><User size={14} className="blue-icon" /> <span><strong>Nombre:</strong> Mar</span></div>
                            <div className="dev-info-item"><Mail size={14} className="blue-icon" /> <span><strong>Correo:</strong> </span></div>
                            <div className="dev-info-item"><Package size={14} className="blue-icon" /> <span><strong>Puesto:</strong> Full Stack Developer</span></div>
                        </div>
                    </div>
